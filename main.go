...
func main() {
	...
	flag.StringVar(&watchNamespace, "namespace", "", "Namespace in which to watch for ST4SD deployments. If empty, watch all namespaces")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "be4c347a.st4sd.ibm.com",
